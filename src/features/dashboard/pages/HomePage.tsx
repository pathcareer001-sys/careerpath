      ...
      <main>
        <section className="border-b border-slate-200 bg-white">
          <div className="mx-auto grid min-h-[calc(100vh-64px)] max-w-7xl gap-10 px-6 py-12 lg:grid-cols-[1.02fr_0.98fr] lg:px-8 lg:py-14">
            <div className="flex flex-col justify-center">
              <div className="mb-5 inline-flex w-fit items-center gap-2 rounded-lg bg-surface-alt px-3 py-1.5 text-sm font-medium text-blue-600">
                <ShieldCheck size="15" />
                Verified internships and reviewed companies
              </div>

              <h1 className="max-w-3xl text-4xl font-medium leading-tight text-slate-900 md:text-5xl">
              ...
              <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                ...
                <Link
                  to="/login"
                  className="inline-flex h-10 items-center justify-center gap-2 rounded-lg border border-slate-200 bg-white px-5 text-sm font-medium text-slate-700 transition-colors hover:bg-slate-50"
                >
                  Sign in
                </Link>
              </div>
              ...
              <div className="mt-8 flex gap-8 border-t border-slate-100 pt-6">
                <div>
                  <p className="text-[22px] font-medium text-slate-900">{companyCount}+</p>
                  <p className="text-sm text-slate-500">Companies</p>
                </div>
                <div>
                  <p className="text-[22px] font-medium text-slate-900">{internshipCount}+</p>
                  <p className="text-sm text-slate-500">Open roles</p>
                </div>
                <div>
                  <p className="text-[22px] font-medium text-slate-900">4.8</p>
            ...
            <div className="flex items-center">
              <div className="w-full rounded-xl border border-slate-200 bg-white">
                <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4">
                  ...
                  <span className="inline-flex items-center gap-1.5 rounded-lg bg-surface-alt px-2.5 py-1 text-xs font-medium text-blue-600">
                ...
                <div className="grid gap-4 p-5 md:grid-cols-[1fr_0.78fr]">
                  <div className="space-y-3">
                    {[
                      ...
                      <div key={role} className="rounded-lg border border-slate-100 bg-surface-alt p-4">
          ...
          <div className="mx-auto flex max-w-7xl flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-wrap gap-2">
              {partnerNames.map((name) => (
                <span key={name} className="rounded-lg border border-slate-200 bg-surface-alt px-3 py-1.5 text-xs font-medium text-slate-600">
                  {name}
                </span>
              ))}
            </div>
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {workflow.map((item) => (
              <div key={item.title} className="rounded-xl border border-slate-200 bg-white p-5">
                <div className="mb-4 flex h-9 w-9 items-center justify-center rounded-lg bg-blue-600 text-white">
                  <item.icon size="18" />
                </div>
        ...
        <section className="mx-auto max-w-7xl px-6 py-12">
          <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div>
              <p className="text-xs font-medium text-slate-500 uppercase tracking-wider">Built for better decisions</p>
        ...
        <section className="bg-slate-900 px-6 py-12 text-white">
          <div className="mx-auto flex max-w-7xl flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            ...
            <Link
              to="/register"
              className="inline-flex h-10 w-fit items-center justify-center gap-2 rounded-lg bg-white px-5 text-sm font-medium text-slate-900 transition-colors hover:bg-slate-100"
            >
              Create account
              <ArrowRight size="16" />
            </Link>
