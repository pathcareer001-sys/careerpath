    ...
    <PageContainer>
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-4 animate-fade-in-up animate-delay-100">
        {[
          ...
          { label: "Accepted", value: accepted, gradient: "from-success/5 to-white", icon: <CheckCircle2 size="16" className="text-success" /> },
          { label: "Rejected", value: rejected, gradient: "from-error/5 to-white", icon: <XCircle size="16" className="text-error" /> },
        ].map((stat) => (
